...
export default function AdminPanel() {
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-8 border border-gray-100">
      ...
      <div className="mb-8">
        <div
          className={`inline-flex items-center px-4 py-2 rounded-lg border-2 font-medium ${statusInfo.color}`}
        >
        ...
        <div className="space-y-4">
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
            <p className="text-purple-800">
              <span className="font-medium">Phase active :</span> Les électeurs
        ...
        <div className="space-y-4">
          <div className="p-4 bg-orange-50 border border-orange-200 rounded-lg">
            <p className="text-orange-800">
              <span className="font-medium">Étape suivante :</span> Prêt à
        ...
        <div className="space-y-4">
          <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
            <p className="text-green-800">
              <span className="font-medium">Vote en cours :</span> Les électeurs
              peuvent maintenant voter pour leurs propositions préférées.
            </p>
          </div>
          <button
        ...
        <div className="space-y-4">
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-red-800">
              <span className="font-medium">Vote fermé :</span> Prêt pour le
      ...
      {workflowStatus === 5 && (
        <div className="p-6 bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-emerald-200 rounded-xl text-center">
          ...
          <p className="text-emerald-700">
            Le dépouillement est terminé et les résultats sont disponibles
            publiquement.
          </p>
        </div>
      )}
